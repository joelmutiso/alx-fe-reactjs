...
function UserProfile() {
  return (
    <div className="user-profile bg-gray-100 p-8 max-w-sm mx-auto my-20 rounded-lg shadow-lg sm:p-4 md:p-8 sm:max-w-xs md:max-w-sm hover:shadow-xl">
      <img src="https://via.placeholder.com/150" alt="User" className='rounded-full sm:h-24 w-36 h-36 mx-auto sm:w-24 h-24 md:w-36 md:h-36 hover:scale-110 transition-transform duration-300 ease-in-out'/>
